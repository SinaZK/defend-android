...
public class InfoSearchActivity extends Activity {
    ...
    ArrayList<Infographic> data = new ArrayList<>();
    ...
    private void sendSearchRequest(String searchTerm) {
        ...
        String url = Constants.API_URL + String.format(Constants.API_SEARCH_INFO, searchTerm);
    ...
    private boolean updateData(JSONArray response) {
        for(int i = 0;i < response.length();i++) {
            Infographic _data = new Infographic();
