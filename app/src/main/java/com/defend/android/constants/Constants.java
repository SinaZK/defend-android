...
//    public static String API_URL = "http://192.168.43.36:8000/";
    ...
    public static String API_LIST_MAGAZINE_CATEGORIES = "magazine/categories/"; //GET
    public static String API_LIST_MAGAZINE_ALL = "magazine/all/"; //GET
    ...
    public static String EXTRA_MAGAZINE_JSON = "magazine";
    ...
    public static int MENU_HAVAFAZA_MAG = 14;
    ...
    //Events
    public static String EVENT_TYPE_REGULAR = "regular";
    public static String EVENT_TYPE_THESIS = "thesis";
}
