...
public class EBookSearchListAdapter extends RecyclerView.Adapter<EBookSearchListAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(MyApp.getInstance())
                .inflate(R.layout.ebook_search_list_item, viewGroup, false);
