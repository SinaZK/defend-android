...
public class HomeFragment extends Fragment {
    ...
    private void initRV() {
        ...
        items.add(new HomeItem(getString(R.string.card_havafaza_mag), Constants.MENU_HAVAFAZA_MAG, R.drawable.havafaza_mag));
        items.add(new HomeItem(getString(R.string.card_atlas), Constants.MENU_WARFARE, R.drawable.globe_new));
        items.add(new HomeItem(getString(R.string.card_book), Constants.MENU_BOOKS, R.drawable.book_store));
